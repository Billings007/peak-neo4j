...
## Minor Combinations
The next table shows the count of students receiving minors outside MAPS for each of the MAPS minors that they earn.
```{r minorComb, echo=FALSE}
mhlW <- mhLong %>% mutate(minorNum = ifelse(minor %in% mm, "Minor1", "AddMinor"))#there are 8 students with 2 maps minors - need to deal with this
amc <- function(x) {
...
Notice that for every MAPS minor, **Psychology** is either the first or second most popular additional minor.
